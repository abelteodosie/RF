...
public class MainClass {
	...
	public static void main(String[] args) {
		double[][] learningSet = FileUtils.readLearningSetFromFile("D:\\Facultate\\An IV\\An IV\\Semestrul II\\RF\\RF - repository\\Lab2-RF\\bin\\in.txt");
		...
		FileUtils.writeLearningSetToFile("D:\\Facultate\\An IV\\An IV\\Semestrul II\\RF\\RF - repository\\Lab2-RF\\bin\\scaledSet.csv", StatisticsUtils.autoscaleLearningSet(learningSet,featureWeightedAverages,featureDispersions));
