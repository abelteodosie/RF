...
public class FileUtils 
{
	...
	protected static double[][] readLearningSetFromFile(String fileName) throws ex
	{
		...
		{
			throw new ex(" We cannot find the scepicified file on USV computer");
		}	
		catch (IOException ioe) {
			throw new ex(" We encountered some errors while trying to read the specified file: " + ioe.getMessage());
		}
		catch (Exception e) {
			throw new ex(" Other errors: " + e.getMessage());
		}	
